...
// LAST BUILD: 2022-09-11 00:58:20
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 125;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0xc636eeed191fd62d;
		
		constexpr char version_string[] = "v0.1.125";
		constexpr char build_time_string[] = "2022-09-11 00:58:20";
		constexpr char phrase[] = "another-catering-ammonium";
		constexpr char calver[] = "2022.36.125";
