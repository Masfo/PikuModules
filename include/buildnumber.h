...
// LAST BUILD: 2022-09-15 18:25:04
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 827;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x9960616ad75eebb7;
		
		constexpr char version_string[] = "v0.1.827";
		constexpr char build_time_string[] = "2022-09-15 18:25:04";
		constexpr char phrase[] = "ladies-acclaim-cosmic";
		constexpr char calver[] = "2022.37.827";
