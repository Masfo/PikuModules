...
// LAST BUILD: 2022-09-16 15:44:20
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 840;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x28dfeabf60b9f658;
		
		constexpr char version_string[] = "v0.1.840";
		constexpr char build_time_string[] = "2022-09-16 15:44:20";
		constexpr char phrase[] = "umpire-pointer-comply";
		constexpr char calver[] = "2022.37.840";
