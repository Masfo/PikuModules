...
// LAST BUILD: 2022-09-13 23:48:50
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 756;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x3d2f0d243afcbd0c;
		
		constexpr char version_string[] = "v0.1.756";
		constexpr char build_time_string[] = "2022-09-13 23:48:50";
		constexpr char phrase[] = "kinship-comfy-wrinkle";
		constexpr char calver[] = "2022.37.756";
