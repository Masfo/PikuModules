...
// LAST BUILD (CMAKE): 2022-10-20 22:28:40
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 1292;
		
		constexpr uint32_t version = major * 100000 + minor * 10000 + build;
		constexpr uint64_t random_seed = 0xcf60d7eeccee6d23;
		
		constexpr char version_string[] = "v0.1.1292";
		constexpr char build_time_string[] = "2022-10-20 22:28:40";
		constexpr char phrase[] = "trump-recoil-bride";
		constexpr char calver[] = "2022.42.1292";
