...
// LAST BUILD: 2022-09-11 00:38:13
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 123;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x86ee25b1636ec7da;
		
		constexpr char version_string[] = "v0.1.123";
		constexpr char build_time_string[] = "2022-09-11 00:38:13";
		constexpr char phrase[] = "static-carpentry-agnostic";
		constexpr char calver[] = "2022.36.123";
