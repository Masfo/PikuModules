...
// LAST BUILD: 2022-09-11 01:21:20
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 132;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x906963910a189925;
		
		constexpr char version_string[] = "v0.1.132";
		constexpr char build_time_string[] = "2022-09-11 01:21:20";
		constexpr char phrase[] = "gratitude-mundane-endeared";
		constexpr char calver[] = "2022.36.132";
