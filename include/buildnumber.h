...
// LAST BUILD: 2022-09-12 22:57:08
...
namespace PikuModulesVersion
{
		...
		constexpr uint64_t random_seed = 0x1d6ef3358ba5ee5a;
		
		constexpr char version_string[] = "v0.1.295";
		constexpr char build_time_string[] = "2022-09-12 22:57:08";
		constexpr char phrase[] = "tapering-outsell-exfoliate";
		constexpr char calver[] = "2022.37.295";
