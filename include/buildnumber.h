...
// LAST BUILD: 2022-09-13 12:03:41
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 337;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0xbfd041ae0538ac10;
		
		constexpr char version_string[] = "v0.1.337";
		constexpr char build_time_string[] = "2022-09-13 12:03:41";
		constexpr char phrase[] = "rounding-wooing-spied";
		constexpr char calver[] = "2022.37.337";
