...
// LAST BUILD: 2022-09-15 15:18:37
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 822;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0xc22c10f6d96557bb;
		
		constexpr char version_string[] = "v0.1.822";
		constexpr char build_time_string[] = "2022-09-15 15:18:37";
		constexpr char phrase[] = "prideful-drapery-balancing";
		constexpr char calver[] = "2022.37.822";
