...
// LAST BUILD: 2022-09-20 19:38:09
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 1041;
		
		constexpr uint32_t version = major * 100000 + minor * 10000 + build;
		constexpr uint64_t random_seed = 0x36480d946ff73dde;
		
		constexpr char version_string[] = "v0.1.1041";
		constexpr char build_time_string[] = "2022-09-20 19:38:09";
		constexpr char phrase[] = "task-dramatize-sudden";
		constexpr char calver[] = "2022.38.1041";
