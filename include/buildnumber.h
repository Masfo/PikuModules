...
// LAST BUILD: 2022-09-11 02:01:56
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 144;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x344765c9e8b9cdf0;
		
		constexpr char version_string[] = "v0.1.144";
		constexpr char build_time_string[] = "2022-09-11 02:01:56";
		constexpr char phrase[] = "shine-lemon-reprint";
		constexpr char calver[] = "2022.36.144";
