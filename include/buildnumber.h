...
// LAST BUILD: 2022-09-12 23:03:47
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 296;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x6a0582d65b204c26;
		
		constexpr char version_string[] = "v0.1.296";
		constexpr char build_time_string[] = "2022-09-12 23:03:47";
		constexpr char phrase[] = "cardigan-frown-fled";
		constexpr char calver[] = "2022.37.296";
