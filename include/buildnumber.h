...
// LAST BUILD: 2022-09-13 15:00:06
...
namespace PikuModulesVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 363;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x2ab1b9ae1c0eff62;
		
		constexpr char version_string[] = "v0.1.363";
		constexpr char build_time_string[] = "2022-09-13 15:00:06";
		constexpr char phrase[] = "shallow-evident-vending";
		constexpr char calver[] = "2022.37.363";
